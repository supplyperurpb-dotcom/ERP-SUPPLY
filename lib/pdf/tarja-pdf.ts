...
export async function generarTarjaPdf({
  tarjaNumero,
  palletNumero,
  fechaEmision,
  proveedor,
  ...
  page.drawText("Módulo / Turno / Variedad", { x: margen, y, size: 7, font: bold, color: NEGRO });
  ...
  for (const linea of lineas) {
    ...
    page.drawText(`${linea.modulo} / ${linea.turno} / ${linea.variedad}`, {
      x: margen,
      y,
      size: 7,
      font: regular,
